...
export const timelineData: TimelineEvent[] = [
  ...
  },
  {
    ...
    location: 'London, UK (Hybrid)',
    type: 'experience',
    description: 'Architected and deployed production ML systems for financial forecasting and risk analysis, handling high-volume transaction data with real-time processing requirements.',
    highlights: [
  ...
  // ============================================
  {
    ...
    location: 'Online',
    type: 'certification',
    description: 'Intensive program covering advanced ML systems, production deployment, and real-world AI applications with hands-on projects.',
    highlights: [
  ...
  },
  {
    ...
    company: 'University of London (Queen Mary)',
    location: 'London, UK',
    type: 'education',
    description: 'Advanced studies in machine learning, neural networks, natural language processing, and computer vision with research focus on deep learning applications.',
    highlights: [
      'Specialized in deep learning and neural network architectures',
      'Research project on NLP and text classification',
      'Coursework: Computer Vision, Reinforcement Learning, Probabilistic AI',
      'Distinction grade with published research paper',
    ],
    tags: ['AI', 'Machine Learning', 'Deep Learning', 'NLP', 'Computer Vision', 'Academic'],
  },
  {
    id: 'bsc-cs',
    date: '2012',
